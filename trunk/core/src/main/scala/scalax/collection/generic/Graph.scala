...
/**
 * Methods common to the companion objects of any graph trait/class.
 * 
 ...
 */
trait GraphCompanion[+CC[N, E[X] <: EdgeLikeIn[X]] <: Graph[N,E] with GraphLike[N,E,CC[N,E]]]
{
  type Coll = CC[_,Nothing]
